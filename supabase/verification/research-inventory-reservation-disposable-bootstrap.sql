...
-- production migration. By default this matches production: neither canonical
-- reservation table exists. Set precreate_track_b_reservations=1 only for the
-- separate convergence lane that reproduces the dormant Track B schema.
\ir research-inventory-lot-coa-disposable-bootstrap.sql
\ir ../research-inventory-lot-coa-admin.sql

\if :{?precreate_track_b_reservations}
