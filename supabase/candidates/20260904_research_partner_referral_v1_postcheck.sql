...
where n.nspname='public' and c.relname in ('research_affiliate_customer_bindings','research_partner_referral_events',
  'research_referral_binding_transfer_events','research_referral_privacy_cleanup_work',
  'research_referral_privacy_cleanup_events');
...
select count(*) as leaked_privacy_work_rows from public.research_referral_privacy_cleanup_work;
