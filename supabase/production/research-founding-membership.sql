...
-- Included verbatim from supabase/research-fm-esign.sql. OpenSign is the
-- signature EXECUTION provider; the native agreement engine (Domain 4) stays
-- the source of legal truth. All three tables RLS-enabled, server-only.
-- ==========================================================================
