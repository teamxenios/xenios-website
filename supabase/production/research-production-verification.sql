...
-- 6. All eight additive Website 3 tables exist with RLS enabled and forced.
...
with expected(table_name) as (
  values
    ...
    ('research_supplement_placeholders'),
...
--     pathway_count = 3, supplement_count = 4, superpower_count = 1,
...
select
  ...
  (select count(*) from public.research_supplement_placeholders) as supplement_count,
