...
The bounded staging directive designates `tetynodzrtmdbuzgboro`, permits restoration and up to five synthetic identities with one benign private test PDF, and prohibits new charges or external effects. A restored the existing Free project once, installed exact e55 as20260908164502 with full pre/postchecks, and created five synthetic identities/three members/two partners plus five real password sessions. Existing user/application and outbox2 remain. The subsequent managed qualification retained five resources, three withdrawn versions and five private objects, with zero published pointers and outbox2 unchanged. See `docs/revenue-launch/20260907/STAGING_MANAGED_TEST_PLAN_20260908.md`, `staging-hub-installation-20260908.json` and `staging-synthetic-fixtures-20260908.json`. The managed API and actual browser workflow passed; formal B acceptance remains engineering work. No repeated environment approval is needed.
