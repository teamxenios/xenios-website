    ...
    <>
      ...
      >
        <ResearchPendingPanel
          ...
          action={
            <Link
              href={ACCESS_ROUTES.support}
              className="btn btn-secondary"
              data-testid="link-application-support"
            >
              Contact support
            </Link>
          }
        ...
        <section className="card mt-6" aria-labelledby="application-next-step">
          ...
          <p className="body-s text-ink-2 mt-2 max-w-[56ch]">
            No application has been started or saved from this page. When the
            approved documents are available, this same route will present the
            complete application and its required acknowledgements.
          </p>
