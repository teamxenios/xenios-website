      ...
      >
        ...
        <section className="card mt-6" aria-labelledby="supplier-start">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <Link href="/research/account/sign-in" className="btn btn-primary">Account login</Link>
            <a href="mailto:research@xeniostechnology.com?subject=Xenios%20supplier%20access" className="btn btn-secondary">Contact supplier operations</a>
          </div>
        </section>
      </ResearchPublicShell>
    </>
