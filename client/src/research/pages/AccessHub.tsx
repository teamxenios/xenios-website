...
const ACCESS_OPTIONS = [
  ...
  },
  {
    ...
    body: "One verified Xenios account will enter authorized organizations, business profiles, users, orders, invoices, and prior order history. Organization workspaces are being finalized; contact business support to prepare access.",
    primary: { label: "Contact business support", href: "mailto:research@xeniostechnology.com?subject=Xenios%20organization%20access" },
