  ...
  return (
    <div className="grid min-w-0 gap-6 [&_.ra-tabs_button]:min-h-11 [&_.ra-tabs_button]:min-w-11">
      ...
      <AdminBoundary
        ...
        unavailableTitle="The question inbox is unavailable."
        unavailableBody="Questions could not be read. This does not mean the inbox is empty; retry to check its current state."
      >
