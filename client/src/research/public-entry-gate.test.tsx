...
describe("public entry, with the shared review gate LOCKED", () => {
  const OPEN = [
    ...
    ["/research/policies/privacy", "the exact privacy link in the gateway footer"],
    ["/research/policies/terms", "the exact terms link in the gateway footer"],
  ] as const;
  ...
  const GATED = [
    ...
    "/research/support",
    // Near-miss: a prefix match instead of an exact allowlist would open this.
