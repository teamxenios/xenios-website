...
describe("member catalog experience", () => {
  it("matches the Research shell and presents truthful public facts", () => {
    ...
    expect(html).not.toMatch(
      /Renew 360|Northline|source_reference|reference_sizes|official source url|supplier \/ reseller state|private reference|Add to cart|Buy now|linear-gradient|radial-gradient|shadow-(?:sm|md|lg|xl)|rounded-2xl/i,
    );
  });
