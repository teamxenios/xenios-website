...
const SYNTHETIC_IMPORT_REPORT: ImportDryRunReportDto = Object.freeze({
  ...
  unmappedInterests: Object.freeze(["Example item awaiting mapping"]),
  ambiguousBlendStrings: Object.freeze([{ raw: "Example blend A / B", occurrences: 2 }]),
  ...
  exceptions: Object.freeze([
    Object.freeze({ kind: "ambiguous_blend" as const, detail: "Example blend A / B", occurrences: 2 }),
    Object.freeze({ kind: "unmapped_interest" as const, detail: "Example item awaiting mapping", occurrences: 1 }),
  ]),
