...
const data: OrganizationDashboardDto = {
  ...
  orders: [{
    ...
    currency: "usd",
    lines: [
      { sku: "ROMAN-21", displayName: "Roman Digital normal order", quantity: 21, lineTotalCents: 5250 },
      { sku: "ROMAN-50", displayName: "Roman Digital normal order", quantity: 50, lineTotalCents: 7250 },
    ],
