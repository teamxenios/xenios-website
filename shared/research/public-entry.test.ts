...
const OPEN = [
  ...
  "/research/application-status",
  // The gateway footer's three links (Gateway.tsx, post-#154)
  "/research/privacy",
  "/research/terms",
  "/research/support",
  // MinimalChrome's footer still links the PolicyPage twins (layout.tsx)
...
const STILL_GATED = [
  ...
  "/research/policies/research-use", // only the two MinimalChrome links are open
