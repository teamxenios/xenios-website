...
describe("assessEarlyAccessEligibility", () => {
  ...
  describe("supplier, fulfillment, quantity, documentation", () => {
    ...
    it("blocks a missing or out-of-range quantity limit", () => {
      ...
      // 51 rather than 4: F-013 set the band at one through fifty, so a
      // declared limit of 4 or 21 is a legal Product Control decision and only
      // a limit outside the band is a blocker.
