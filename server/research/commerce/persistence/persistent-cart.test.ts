...
const selection: CartProductSelection = {
  ...
  canonicalReadiness: {
    ...
    inputVersions: [{ id: "55555555-5555-4555-8555-555555555555", version: 2 }],
    domainVersions: [{ domain: "product_content", version: 4 }],
  },
  inventoryEligibility: {
    productId: product,
    variantId: variant,
    state: "eligible",
    sourceVersion: "inventory:9",
    evaluatedAt: "2026-07-27T20:00:00Z",
  },
  evaluatedAt: "2026-07-27T20:00:00Z",
};
