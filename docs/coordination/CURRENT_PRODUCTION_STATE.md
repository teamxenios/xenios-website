...
Frozen Hub/UI application c350ab1c1a12d8f9ed7e8e380d4f2ef9eda22662, tree314ef445a6e3be8420a77451ed182088419d59ec, remains undeployed. Its corrected migration LF SHA-256 is e55f965fbc942b4de6ec7b74b2bc28b8d7eff8dd6530f50c9876d3137e8dd722; candidate and managed copies match and remain PENDING. The earlier9ed2203f/6859a8d3 source registration is historical. All three Hub tables were absent in A's fresh SQL metadata result.

The [current qualification](../revenue-launch/20260907/RESOURCE_HUB_RELEASE_QUALIFICATION.md) records154/154 local checks on each of PostgreSQL17.5 and18.3, retaining earlier failed/superseded evidence. Final c350 full suite passed15,997 tests/59 skipped/zero failed; typecheck/build and bounded source review passed. Matched-disabled endpoint controls agree across30 routes after reproducing the original27/3 environment mismatch on baseline. Privacy V3 is prepared (13 entries, 6 eligible, 131 bytes); actual hash/coverage approval and strict PII remain pending. Real managed adapter/role scope and new production authority remain open. No Hub production action is authorized.
