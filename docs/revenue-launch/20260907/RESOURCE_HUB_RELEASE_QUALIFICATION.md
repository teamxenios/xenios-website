...
| PII verification | **PREPARED, HASH APPROVAL PENDING.** V3: 13 entries / 6 scanner-eligible / 131 bytes; SHA-256 `27fb9d7052867808f8cee5f3147fa34855fad0d893a6a14508b9212198ce4fbb`. [Preparation, coverage and provenance](privacy-input-v3-preparation-receipt.json). V2 remains unchanged; all three originals match their register hashes. Image-only names and ambiguous original-filename identity remain coverage limitations. No strict PII PASS exists. |
