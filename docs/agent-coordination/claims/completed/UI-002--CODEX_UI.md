...
- Member dashboard supports empty, pending, qualified, earned, and expired visual states without real backend claims.
- The invite landing states that invitations never guarantee approval.
