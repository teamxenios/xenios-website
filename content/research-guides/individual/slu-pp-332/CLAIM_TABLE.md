...
| --- | --- | --- | --- | --- | --- | --- |
| ID-01 | SLU-PP-332 is a synthetic small molecule, not a peptide, despite being sold widely through peptide-branded channels. | A | S11, S2 | Not population dependent, chemical fact | Allowed | Wikipedia is used for identity only. Formula C18H14N2O2, molar mass 290.322 g/mol, CAS 303760-60-3. This correction should appear early in the Guide because a buyer who believes they hold a peptide has a wrong model of the substance and of what test would even verify it. |
...
| HU-02 | A direct query of the ClinicalTrials.gov registry for this compound returned zero registered studies. | A | S1 | Humans | Allowed | Query dated 2026-07-19. Must be re-run before publication. |
...
| PC-02 | In mouse models of obesity and metabolic syndrome, the compound was reported to increase energy expenditure and fatty acid oxidation, with decreased fat mass accumulation. | D | S8 | Mice | Allowed, with species in the same sentence and a provisional flag | S8 content came from a search result summary after a blocked direct fetch. A reviewer should read the primary text before publication. Never present this as a fat loss claim for a person. |
| PC-03 | In a mouse pressure-overload heart failure model, SLU-PP-332 and SLU-PP-915 were reported to improve ejection fraction, reduce fibrosis, and increase survival. | D | S10 | Mice | Allowed, with species in the same sentence and a provisional flag | Full text not retrieved. Note that this finding covers both compounds. Cardiac framing is high risk for misreading, so the species qualifier is mandatory. |
...
| PC-06 | The published literature states that SLU-PP-332 is not orally bioavailable, which is given as the reason a chemically distinct successor compound was developed. | D | S9 | Mice | Allowed, and materially relevant to anyone evaluating an oral product | Provisional pending direct retrieval of S9. This directly undercuts the premise of oral products sold under this name. |
...
| ID | Claim as it would appear to a member | Grade | Sources | Population it applies to | Member-facing | Reviewer notes |
| --- | --- | --- | --- | --- | --- | --- |
| REG-01 | No FDA approval for any indication was located, and the compound was not found on the retrieved FDA 503A compounding list. | D for the negative finding | S12 | United States | Allowed, with the negative-finding qualifier | This is an absence of a retrieved document. FDA appears simply not to have addressed the compound. It must never be presented as FDA having reviewed and cleared it. See REGULATORY_STATUS.md. |
...
| REG-03 | Anti-doping classification could not be confirmed from WADA's own documents this session. An athlete should confirm current status directly with WADA or their national anti-doping organization. | G | S13 failed retrieval, S6 and S7 for the cautious peer-reviewed wording | Tested athletes | Allowed, and this is the only permitted formulation | The peer-reviewed papers say only that WADA prohibits exercise mimetics and metabolic modulators as a class, or that non-approved substances with performance-enhancing potential can be subject to the list. Neither asserts current listing of this compound. |
